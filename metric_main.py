...
@register_metric
def fid_custom_5k580(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fid = frechet_inception_distance.compute_fid(opts, max_real=5580, num_gen=5580)
    return dict(fid_custom_5k580=fid)

@register_metric
def fid_custom_580(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fid = frechet_inception_distance.compute_fid(opts, max_real=580, num_gen=580)
    return dict(fid_custom_580=fid)

@register_metric
def fid_custom_5k(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fid = frechet_inception_distance.compute_fid(opts, max_real=5000, num_gen=5000)
    return dict(fid_custom_5k=fid)

@register_metric
def fid_custom_6k156(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fid = frechet_inception_distance.compute_fid(opts, max_real=6156, num_gen=6156)
    return dict(fid_custom=fid)

@register_metric
def fid_custom(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fid = frechet_inception_distance.compute_fid(opts, max_real=4, num_gen=4)
    return dict(fid_custom=fid)
